...
from Merge_app.config import settings
from Merge_app.db.session import init_db, dispose_db
from Merge_app.api.chart_ws import chart_router
from Merge_app.api.rest import rest_router
